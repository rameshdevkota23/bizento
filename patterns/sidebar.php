...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo esc_html__('Recent post', 'bizento'); ?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo esc_html__('Tags', 'bizento'); ?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo esc_html__('Categories', 'bizento'); ?></h4>
<!-- /wp:heading -->
